...
function getWorld(t) {
    var i = "https://api.guildwars2.com/v2/worlds?lang=en&ids=" + t;
    ...
    $("#wallet p.error").remove(), $("#wallet > div").show(), $.ajax({
        ...
        success: function(t, i, s) {
            $.each(t, function() {
                ...
                type: "GET",
                url: "https://api.guildwars2.com/v2/currencies?lang=en&ids=all",
                dataType: "json",
                cache: !1,
                timeout: 1e4,
                success: function(t, i, s) {
...
function getTitles(t) {
    $.ajax({
        type: "GET",
        url: "https://api.guildwars2.com/v2/titles?lang=en&ids=" + t,
        dataType: "json",
        cache: !0,
        timeout: 1e4,
        success: function(t) {
...
function getTitleAchievements(t) {
    $.ajax({
        type: "GET",
        url: "https://api.guildwars2.com/v2/achievements?lang=en&ids=" + t,
        dataType: "json",
        cache: !0,
        timeout: 1e4,
        success: function(t) {
...
function getFinishers(t) { $.ajax({ type: "GET", url: "https://api.guildwars2.com/v2/finishers?lang=en&ids=" + t, dataType: "json", cache: !0, timeout: 1e4, success: function(t) { $.each(t, function() { $('#unlocks .finishers div[data-finisher-id="' + this.id + '"]').css("order", this.order), $('#unlocks .finishers div[data-finisher-id="' + this.id + '"] img').attr("data-src", this.icon), $('#unlocks .finishers div[data-finisher-id="' + this.id + '"] .name').html(this.name) }) }, error: function() {} }) }

function getMinis(t) {
    $.ajax({
        type: "GET",
        url: "https://api.guildwars2.com/v2/minis?lang=en&ids=" + t,
        dataType: "json",
        cache: !0,
        timeout: 1e4,
        success: function(t) {
...
function getDyeColors(t) {
    $.ajax({
        type: "GET",
        url: "https://api.guildwars2.com/v2/colors?lang=en&ids=" + t,
        dataType: "json",
        cache: !0,
        timeout: 1e4,
        success: function(t) {
...
function getWardrobeSkins(t) {
    $.ajax({
        type: "GET",
        url: "https://api.guildwars2.com/v2/skins?lang=en&ids=" + t,
        dataType: "json",
        cache: !0,
        timeout: 1e4,
        success: function(t) {
...
function getAchievementTitles(t) { $.ajax({ type: "GET", url: "https://api.guildwars2.com/v2/titles?lang=en&ids=" + t, dataType: "json", cache: !0, timeout: 1e4, success: function(t) { $.each(t, function() { $('.achievement-container span[data-title-id="' + this.id + '"]').html(this.name) }) }, error: function() {} }) }
var key = "",
...
function getStackedItems() {
    $.ajax({
        ...
        timeout: 1e4,
        success: function (t, i, s) {
            $("#StackedItems .total-values").addClass("visible");
            var a = [],
                e = [],
                n = [],
                r = $("#itemLinks").val(),
            ...
            $("#StackedItems > div.item-list").append(o);
            getBankItemDetails(a, n);
            getPrices(a);
            e.length && (getBankItemDetails(e, n), getPrices(e));
        },
        error: function () {
            $("#StackedItems > div.item-list").html("<p class='error'>Inventories API key permission required.</p>");
            $("#StackedItems .total-values").removeClass("visible");
        },
    });
}